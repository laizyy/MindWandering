...
instruction1 = "In this experiment you will be shown words written in uppercase or lowercase. Press the m-key when the word is written in lowercase (e.g. mountain). It is important that you react as fast as possible. Don't press anything when the word is written in uppercase (e.g. BRIDGE). \n\n Press any key to continue."
instruction2 = "During the experiment you will occassionally be asked what you were thinking about. You can answer the questions by pressing the applicable key on the keyboard or adjusting the slider where applicable.\n\n Press any key to continue to some examples."
...
startQuestion1 = "Are you feeling stressed? \n 1 = not stressed at all, 5 = very stressed \n \nUse the slider to indicate how stressed you are."
startQuestion2 = "Are you feeling happy? \n 1 = very unhappy, 5 = very happy \n \nUse the slider to indicate how happy you are."
...
expInfo = {'Experiment':expName, 'Participant ID':'test', 'Participant number':'99'}
